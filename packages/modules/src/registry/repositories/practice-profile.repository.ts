...
import { DEFAULT_OWNER_COUNTRY, type OwnerContact, type OwnerContactInput, type OwnerContactKind } from '@vet/types/domain/owner/owner.js';
import { validateImageCollectionItems } from '@vet/types/domain/image-collection/image-collection.js';
import type {
	PracticeIdentity,
	PracticeProfiles,
	VeterinarianProfile,
	...
	Workplace,
	WorkplaceInput
} from '@vet/types/domain/practice-profile/practice-profile.js';
import { formatEmailForInput } from '@vet/types/domain/shared/email.js';
import { FIELD_LIMITS, assertTextLimit, nullableLimitedText, nullableMultilineText } from '@vet/types/domain/shared/field-limits.js';
...
import { getImageCollection, replaceImageCollection } from '@vet/modules/core_repositories/image-collection.repository.js';
import { loadMediaData, saveMedia } from '@vet/modules/core_repositories/media.repository.js';
