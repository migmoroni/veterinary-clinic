import type { Pet, PetBreed, PetInput, PetSex, PetSpecies } from '@vet/types/domain/pet/pet.js';
import { isPetBreed, isPetBreedForSpecies, isPetSpecies } from '@vet/types/domain/pet/taxonomy.js';
