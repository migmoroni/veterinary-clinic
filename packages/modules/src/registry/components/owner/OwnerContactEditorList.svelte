<script lang="ts">
	...
	import { countryPhoneFormat, countryPhoneFormats } from '@vet/types/domain/geo/location.js';
	...
	import { formatPhoneForInputWithCaret } from '@vet/types/domain/shared/phone.js';
