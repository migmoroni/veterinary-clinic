import type { OwnerContactInput, OwnerContactKind } from '@vet/types/domain/owner/owner.js';
...
import { formatPhoneForInput, type PhoneFormatContext } from '@vet/types/domain/shared/phone.js';
