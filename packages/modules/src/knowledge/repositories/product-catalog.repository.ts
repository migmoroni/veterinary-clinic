...
import type { ImageCollectionItem, ImageCollectionItemInput, ImageCollectionPolicy } from '@vet/types/domain/image-collection/image-collection.js';
import { FIELD_LIMITS, assertTextLimit, nullableLimitedText } from '@vet/types/domain/shared/field-limits.js';
