import type { MedicalRecord, MedicalRecordDetails, MedicalRecordInput } from '@vet/types/domain/medical-record/medical-record.js';
import {
	createMedicalRecord,
	getMedicalRecordDetails,
	softDeleteMedicalRecord,
	updateMedicalRecord
} from '@vet/modules/medical_records/repositories/medical-record.repository.js';
