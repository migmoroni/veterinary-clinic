<script lang="ts">
	...
	import Textarea from '@vet/ui/components/ui/Textarea.svelte';
	import type { PetSpecies } from '@vet/types/domain/pet/taxonomy.js';
	import { productItemMatchesSpecies } from '@vet/types/domain/product/catalog.js';
	import type { TreatmentProtocol, TreatmentProtocolId } from '@vet/types/domain/treatment/protocol.js';
	import { formatDateForDisplay, normalizeDateInput } from '@vet/types/domain/shared/date-input.js';
	import { FIELD_LIMITS, textLength } from '@vet/types/domain/shared/field-limits.js';
