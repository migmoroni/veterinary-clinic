import { catalogClassificationGroupsSearchText, type CatalogClassificationGroup, type CatalogClassificationRow } from '@vet/types/domain/catalog/classification-groups.js';
import {
