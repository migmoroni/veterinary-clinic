...
O plano está dividido em partes para manter contratos comuns, execução e
critérios de aceite fáceis de consultar.

A documentação canônica começa em:

- [Índice, arquitetura e contratos](./hub-server/README.md)
...
- [Parte 5: updater Tauri com ambiente local](./hub-server/05-tauri-updater-local.md)
- [Parte 6: repositório dedicado e GitHub Releases](./hub-server/06-github-releases-ci.md)
