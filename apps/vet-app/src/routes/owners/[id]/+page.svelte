<script lang="ts">
	...
	import { DEFAULT_OWNER_COUNTRY, type Owner, type OwnerInput } from '@vet/types/domain/owner/owner.js';
				...
				<div class="mt-4 grid gap-4 sm:grid-cols-5">
					<label class="flex flex-col gap-1 text-sm font-medium sm:col-span-5">
						<span class="flex min-w-0 items-baseline justify-between gap-2">
							...
							{#if editing}<CharacterLimitHint value={form.name} max={FIELD_LIMITS.ownerName} />{/if}
						</span>
						<input class="h-10 rounded-md border border-input bg-background px-3 text-sm shadow-sm focus:border-primary focus:outline-none focus:ring-2 focus:ring-ring/30" bind:value={form.name} maxlength={FIELD_LIMITS.ownerName} disabled={!editing} required />
					</label>
					...
					<label class="flex flex-col gap-1 text-sm font-medium sm:col-span-3">
						<span class="flex min-w-0 items-baseline justify-between gap-2">
							...
							{#if editing}<CharacterLimitHint value={form.postalCode} max={FIELD_LIMITS.ownerPostalCode} />{/if}
						</span>
						<span class="flex gap-2">
							<input class="h-10 min-w-0 flex-1 rounded-md border border-input bg-background px-3 text-sm shadow-sm focus:border-primary focus:outline-none focus:ring-2 focus:ring-ring/30" bind:value={form.postalCode} maxlength={FIELD_LIMITS.ownerPostalCode} disabled={!editing} />
					...
					<label class="flex flex-col gap-1 text-sm font-medium sm:col-span-3">
						<span class="flex min-w-0 items-baseline justify-between gap-2">
							...
							{#if editing}<CharacterLimitHint value={form.street} max={FIELD_LIMITS.ownerStreet} />{/if}
						</span>
						<input class="h-10 rounded-md border border-input bg-background px-3 text-sm shadow-sm focus:border-primary focus:outline-none focus:ring-2 focus:ring-ring/30" bind:value={form.street} maxlength={FIELD_LIMITS.ownerStreet} disabled={!editing} />
					</label>

					<label class="flex flex-col gap-1 text-sm font-medium sm:col-span-1">
						<span class="flex min-w-0 items-baseline justify-between gap-2">
							<span>{t('owner.streetNumber')}</span>
							{#if editing}<CharacterLimitHint value={form.streetNumber} max={FIELD_LIMITS.ownerStreetNumber} />{/if}
						</span>
						<input class="h-10 rounded-md border border-input bg-background px-3 text-sm shadow-sm focus:border-primary focus:outline-none focus:ring-2 focus:ring-ring/30" bind:value={form.streetNumber} maxlength={FIELD_LIMITS.ownerStreetNumber} disabled={!editing} />
					</label>

					<label class="flex flex-col gap-1 text-sm font-medium sm:col-span-1">
						<span class="flex min-w-0 items-baseline justify-between gap-2">
							<span>{t('owner.addressComplement')}</span>
							{#if editing}<CharacterLimitHint value={form.addressComplement} max={FIELD_LIMITS.ownerAddressComplement} />{/if}
						</span>
						<input class="h-10 rounded-md border border-input bg-background px-3 text-sm shadow-sm focus:border-primary focus:outline-none focus:ring-2 focus:ring-ring/30" bind:value={form.addressComplement} maxlength={FIELD_LIMITS.ownerAddressComplement} disabled={!editing} />
					</label>

					<label class="flex flex-col gap-1 text-sm font-medium sm:col-span-2">
						<span class="flex min-w-0 items-baseline justify-between gap-2">
							<span>{t('owner.neighborhood')}</span>
							{#if editing}<CharacterLimitHint value={form.neighborhood} max={FIELD_LIMITS.ownerNeighborhood} />{/if}
						</span>
						<input class="h-10 rounded-md border border-input bg-background px-3 text-sm shadow-sm focus:border-primary focus:outline-none focus:ring-2 focus:ring-ring/30" bind:value={form.neighborhood} maxlength={FIELD_LIMITS.ownerNeighborhood} disabled={!editing} />
					</label>

					<label class="flex flex-col gap-1 text-sm font-medium">
						<span class="flex min-w-0 items-baseline justify-between gap-2">
							<span>{t('owner.state')}</span>
							{#if editing && !hasStructuredLocations}<CharacterLimitHint value={form.state} max={FIELD_LIMITS.ownerState} />{/if}
						</span>
						...
						{:else}
							<input id="owner-state" class="h-10 rounded-md border border-input bg-background px-3 text-sm shadow-sm focus:border-primary focus:outline-none focus:ring-2 focus:ring-ring/30" bind:value={form.state} maxlength={FIELD_LIMITS.ownerState} disabled={!editing} autocomplete="address-level1" />
						{/if}
					</label>
					...
					<label class="flex flex-col gap-1 text-sm font-medium sm:col-span-2">
						<span class="flex min-w-0 items-baseline justify-between gap-2">
							...
							{#if editing && !hasStructuredLocations}<CharacterLimitHint value={form.city} max={FIELD_LIMITS.ownerCity} />{/if}
						</span>
						{#if hasStructuredLocations}
						...
						{:else}
							<input id="owner-city" class="h-10 rounded-md border border-input bg-background px-3 text-sm shadow-sm focus:border-primary focus:outline-none focus:ring-2 focus:ring-ring/30" bind:value={form.city} maxlength={FIELD_LIMITS.ownerCity} disabled={!editing} autocomplete="address-level2" />
						{/if}
					</label>
