<script lang="ts">
	...
	import { PetAvatarEditorDialog } from '@vet/modules/registry/pets';
	import { PetTaxonomyPicker } from '@vet/modules/registry/pets';
	import { TreatmentDueBadge } from '@vet/modules/medical_records/treatments';
	import TreatmentPanel from '$lib/components/treatment/TreatmentPanel.svelte';
	...
	import { removePet, savePet } from '@vet/modules/registry/pets';
	import { loadPetProfile, type PetProfile } from '$lib/services/pet-profile.service.js';
	import { saveNewRecord } from '@vet/modules/medical_records/records';
