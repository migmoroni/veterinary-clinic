<script lang="ts">
	...
	import PetAvatarEditorDialog from '@vet/modules/registry/components/pet/PetAvatarEditorDialog.svelte';
	...
	import TreatmentPanel from '@vet/modules/medical_records/components/pet/TreatmentPanel.svelte';
	...
	import { formatDateForDisplay, formatDateForInput, normalizeDateInput } from '@vet/types/domain/shared/date-input.js';
	...
	import { getTreatmentDueStatus, TREATMENT_KINDS, type PetTreatment, type TreatmentKind } from '@vet/types/domain/treatment/treatment.js';
	import { i18n, t, type TranslationKey } from '@vet/core-local/i18n/index.js';
	import type { PetProfile } from '@vet/modules/registry/services/pet.service.js';
	import { loadPetProfile, removePet, savePet } from '@vet/modules/registry/services/pet.service.js';
	import { saveNewRecord } from '@vet/modules/medical_records/services/record.service.js';
