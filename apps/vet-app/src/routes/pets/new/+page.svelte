<script lang="ts">
	...
	import { loadOwnerProfile, searchOwners } from '@vet/modules/registry/services/owner.service.js';
	import { saveNewPet } from '@vet/modules/registry/services/pet.service.js';
