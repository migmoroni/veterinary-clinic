<script lang="ts">
	...
	import BreedReferenceDetail from '$lib/components/pet/BreedReferenceDetail.svelte';
	import type { BreedReferenceProfile } from '$lib/domain/pet/breed-reference.js';
	import { t } from '$lib/i18n/index.js';
	import { loadBreedReferenceProfile } from '$lib/services/breed-reference.service.js';
