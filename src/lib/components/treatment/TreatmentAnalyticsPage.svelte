<script lang="ts">
	...
	import type { TreatmentAnalyticsCatalogItem, TreatmentDueFilterMode, TreatmentHistoryPeriod, TreatmentStatusItem, TreatmentStatusKey, TreatmentStatusSummary } from '$lib/domain/treatment/analytics.js';
	import { emptyTreatmentStatusSummary, shiftIsoDate, todayIsoDate, treatmentHistoryPeriods, treatmentStatusKeys } from '$lib/domain/treatment/analytics.js';
	import type { TranslationKey } from '$lib/i18n/index.js';
	import { i18n, t } from '$lib/i18n/index.js';
	import { loadAnalyticsTreatments, loadTreatmentAnalyticsOverview, loadTreatmentHistory, loadTreatmentStatusItems } from '$lib/services/treatment-analytics.service.js';
