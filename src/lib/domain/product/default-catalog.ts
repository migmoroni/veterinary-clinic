...
export type DefaultMedicationProductType = ProductTypeSubtype<'medication'>;
...
function withProductType(subtype: DefaultMedicationProductType, modules: Record<string, DefaultProductCatalogJsonItem>): DefaultProductCatalogItem[] {
