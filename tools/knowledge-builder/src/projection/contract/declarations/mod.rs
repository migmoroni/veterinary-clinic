//! Independently derives obligations owned by projection operations.

use self::{entities::add_entity_obligations, values::insert_obligation};
...
pub(super) use search::{search_candidates, SearchCandidate};
...
pub(super) fn owned_obligations(
