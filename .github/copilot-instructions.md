...
- [x] Customize the Project
  Added Tailwind 4, Tauri SQL/shell/fs/dialog plugins, SQLite seed resource, app shell, i18n, domain folders, persistence client, migrations, repositories, services, stores and initial routes.
...
- [x] Launch the Project
  User chose not to launch Tauri dev now; launch commands are documented in README.
- [x] Ensure Documentation is Complete
  README.md and docs/architecture.md, docs/build-targets.md, docs/backup-policy.md are present and current.
